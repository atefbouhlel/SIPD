package org.inria.dmsp.test.TEST_Tearing.Deletes.NorLastBeforeFlush;
...
public class Test extends TearingTestFramework
{
	...
	{
		TearingTools.Insert_Tearing_Point(db, out, perf, Macro.TPOINT_DELETE_NORLASTBEFOREFLUSH);
