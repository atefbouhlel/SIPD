package org.inria.dmsp.test.TEST_Tearing.Deletes.NandSrAllUncomm.Recover_121;
...
public class Test extends TearingTestFramework
{
	...
	public void placeAndReachTearingPoint(Connection db, PrintWriter out, int perf) throws Exception
	{
		...
		TearingTools.Insert_Tearing_Point(db, out, perf, Macro.TPOINT_DELETE_NANDSRALLUNCOMM);
