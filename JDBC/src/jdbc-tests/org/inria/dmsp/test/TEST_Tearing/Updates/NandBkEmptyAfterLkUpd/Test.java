package org.inria.dmsp.test.TEST_Tearing.Updates.NandBkEmptyAfterLkUpd;
...
public class Test extends TearingTestFramework
{
	...
	{
		TearingTools.Insert_Tearing_Point(db, out, perf, Macro.TPOINT_UPDATE_NANDBKEMPTYAFTERLKUPD);
