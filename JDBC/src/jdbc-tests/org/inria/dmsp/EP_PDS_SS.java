...
"/*EP \u0001 " + 
"h 1 1 -1 0 ?1 # " + /* CI_LOOKUP ref_tab:Episode(0) key_col_id:0 ka_id:0	 key:?1(R0) -->R1 */
...
"/*EP \u0001 " + 
"h 1 1 -1 4 ?1 # " + /* CI_LOOKUP ref_tab:UserDMSP(2) key_col_id:10 ka_id:4	 key:?1(R0) -->R1 */
...
"/*EP \u0001 " + 
"h 1 1 -1 5 ?1 # " + /* CI_LOOKUP ref_tab:Event(3) key_col_id:28 ka_id:5	 key:?1(R0) -->R1 */
...
"/*EP \u0001 " + 
"h 1 1 -1 2 ?1 # " + /* CI_LOOKUP ref_tab:Event(3) key_col_id:5 ka_id:2	 key:?1(R0) -->R1 */
...
"/*EP \u0001 " + 
"h 1 1 -1 6 ?1 # " + /* CI_LOOKUP ref_tab:Info(4) key_col_id:36 ka_id:6	 key:?1(R0) -->R1 */
...
"/*EP \u0001 " + 
"h 1 1 -1 7 ?1 # " + /* CI_LOOKUP ref_tab:Comment(5) key_col_id:47 ka_id:7	 key:?1(R0) -->R1 */
...
"/*EP \u0001 " + 
"h 1 1 -1 8 ?1 # " + /* CI_LOOKUP ref_tab:Role(6) key_col_id:52 ka_id:8	 key:?1(R0) -->R1 */
...
"/*EP \u0001 " + 
"h 1 1 -1 9 ?1 # " + /* CI_LOOKUP ref_tab:Habilitation(8) key_col_id:57 ka_id:9	 key:?1(R0) -->R1 */
...
"/*EP \u0007 " + 
"h 2 2 -1 5 ?7 # " + /* CI_LOOKUP ref_tab:Event(3) key_col_id:28 ka_id:5	 key:?7(R0) -->R1 */
...
"/*EP \u0005 " + 
"h 1 1 -1 7 ?5 # " + /* CI_LOOKUP ref_tab:Comment(5) key_col_id:47 ka_id:7	 key:?5(R0) -->R1 */
...
"/*EP \u0001 " + 
"h 2 2 -1 6 ?1 # " + /* CI_LOOKUP ref_tab:Info(4) key_col_id:36 ka_id:6	 key:?1(R0) -->R1 */
...
"/*EP \u0001 " + 
"h 2 2 -1 5 ?1 # " + /* CI_LOOKUP ref_tab:Event(3) key_col_id:28 ka_id:5	 key:?1(R0) -->R1 */
